...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Implicit & Explicit Animations',
      theme: ThemeData(
...
class _ColorPaletteScreenState extends State<ColorPaletteScreen>
  ...
  void _toggleColors() {
    setState(() {
      ...
      _showColors ? _controller.forward() : _controller.reverse();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Implicit & Explicit Animation'),
      ),
      body: Center(
...
class ColorDetailScreen extends StatelessWidget {
  ...
  ColorDetailScreen({required this.color, required this.colorName});
